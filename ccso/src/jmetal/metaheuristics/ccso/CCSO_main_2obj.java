...
public class CCSO_main_2obj {
	...
	public static void main(String[] args) throws JMException,
		...
		// Result messages
		population.printObjectivesToFile("CCSOD_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+ "_" + problem.getNumberOfVariables() + "D_run"+(i+1)+".txt" );
