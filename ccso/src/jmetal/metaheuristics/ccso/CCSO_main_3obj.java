...
public class CCSO_main_3obj {
	...
	public static void main(String[] args) throws JMException,
		...
		// Result messages
		population.printObjectivesToFile("CCSOI_"+problem.getNumberOfObjectives()+"Obj_"+problem.getName()+ "_" + problem.getNumberOfVariables() + "D_run"+(i+1)+".txt" );
