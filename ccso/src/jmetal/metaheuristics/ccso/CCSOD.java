...
public class CCSOD extends Algorithm {
	/**
	...
	public void initParams() {
		...
		if(problem_.getNumberOfObjectives() == 2) {
			vg1 = new TwoLevelWeightVectorGenerator(div1_, 0,problem_.getNumberOfObjectives());
			vg2 = new TwoLevelWeightVectorGenerator(div2_, 0,problem_.getNumberOfObjectives());
		}else if(problem_.getNumberOfObjectives() == 3) {
			vg1 = new TwoLevelWeightVectorGenerator(div1_, 6,problem_.getNumberOfObjectives());
			vg2 = new TwoLevelWeightVectorGenerator(div2_, 0,problem_.getNumberOfObjectives());
		}else {
			vg1 = new TwoLevelWeightVectorGenerator(div1_, 3,problem_.getNumberOfObjectives());
			vg2 = new TwoLevelWeightVectorGenerator(div2_, 5,problem_.getNumberOfObjectives());
		}
