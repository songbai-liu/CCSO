...
public class LMCSO_I extends Algorithm {
	/**
	...
	public LMCSO_I(Problem problem) {
		super(problem);
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while (iteration_ < maxIterations_) {
			...
			SolutionSet candidateSet = st[1];
			NondominatedRanking rankings = new NondominatedRanking(candidateSet);
			remain = swarmSize_;
			index = 0;
			...
			if(remain > 0) {
				...
				sortWithHV(front0,candidateSet);
				for (int k = 0; k < remain; k++) {
